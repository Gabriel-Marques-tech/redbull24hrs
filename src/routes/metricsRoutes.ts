...
router.get("/events/:eventId/gender-km",  metricsController.getGenderKm);
router.get("/events/:eventId/pace",       metricsController.getCompetitionPace);
router.get("/events/:eventId/tv",         metricsController.getTvSummary);
